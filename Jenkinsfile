        ...
        stage('Snyk scan') {
         ...
         stage('Scan Docker Container') {
          steps {
            ...
            script {
              sh '/usr/bin/npx snyk container test  nextcloud:10.0.0 --file=./Nextcloud/docker/Dockerfile --format=junit > snyk-results.xml'  // Vervang 'your-docker-image' door de naam van je Docker-image
